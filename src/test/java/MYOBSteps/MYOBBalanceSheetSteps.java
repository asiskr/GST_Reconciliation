...
public class MYOBBalanceSheetSteps extends BaseClass{
    ...
    public void user_extract_gst_collected_gst_paid_gst_actual_gst_last_year() {
        ...
        if (MYOBBalanceSheetPage.LAST_TABLE_DATA.size() > 4) {
            System.out.println("Total: " + MYOBBalanceSheetPage.LAST_TABLE_DATA.get(4).get("Total"));
        } else {
    ...
    public void user_click_on_the_reporting_and_reports_button() throws InterruptedException {
